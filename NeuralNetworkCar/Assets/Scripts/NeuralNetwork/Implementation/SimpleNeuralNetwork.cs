...
{
    private INeuralLayerFactory _layerFactory;

    internal List<INeuralLayer> _layers;
    ...
    /// </summary>
    public void AddLayer(INeuralLayer newLayer)
    {
        if (_layers.Any())
        {
    ...
    private void CreateInputLayer(int numberOfInputNeurons)
    {
        ...
        new TangensHyperbolicusActivationFunction(), new WeightedSumFunction());
